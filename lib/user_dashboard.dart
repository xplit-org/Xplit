...
class _UserDashboardState extends State<UserDashboard> {
  ...
  void _showInviteFriendsDialog() {
    final String shareLink = 'https://expenser.app/invite/${_userData?['mobile_number'] ?? 'N/A'}';
    final String shareText = 'Check out this awesome expense sharing app! Join me using this link: $shareLink';
  ...
  void _showAddFriendDialog() async {
    // Request contacts permission when dialog opens
    ...
    showModalBottomSheet(
      ...
      backgroundColor: Colors.transparent,
      builder: (BuildContext context) {
        // Auto-focus the search box after dialog appears
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TextField(
                    controller: friendMobileController,
              ...
              child: Image.asset('assets/profilepic.png', fit: BoxFit.cover),
                ...
                title: Text('Contact Name', maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black),),
                subtitle: Text('+919876543210', style: TextStyle(fontSize: 12, color: Colors.black),),
